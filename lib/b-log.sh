...
# Script Home: https://github.com/idelsink/b-log
#########################################################################
#
...
# 6: space
# 7: filename
B_LOG_DEFAULT_TEMPLATE="${B_LOG_DEFAULT_TEMPLATE:-[@23:1@][@6:2@][@3@:@3:4@] @5@}"  # default template
...
LOG_LEVELS=(
    ...
    "${LOG_LEVEL_DEBUG}"  "DEBUG"  "${B_LOG_DEFAULT_TEMPLATE}" "\e[1;30m" "\e[0m"
    "${LOG_LEVEL_TRACE}"  "TRACE"  "${B_LOG_DEFAULT_TEMPLATE}" "\e[40;90m" "\e[0m"
)
# log levels columns
